...
<div class="container">
    ...
    <form method="post" action="createCarousel">
        <fieldset>
            <legend><h2>Ajouter un nouveau manège</h2></legend>
            <hr>
            </br>
            ...
            <br />
              ...
              <div class="input-group flex-nowrap">
                ...
                <input type="type" id="duration" name="duration" value="<c:out value="${carousel.duration}"/>" size="20" maxlength="60" class="form-control" aria-label="Duration" aria-describedby="addon-wrapping" placeholder="Durée du manège"/>
            </div>
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="type" id="capacity" name="capacity" value="<c:out value="${carousel.capacity}"/>" size="20" maxlength="60" class="form-control" aria-label="Capacity" aria-describedby="addon-wrapping" placeholder="Capacité"/>
            </div>
